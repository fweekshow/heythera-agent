...
// Red Door Life information
export const RED_DOOR_URL = "https://www.reddoor.life";
export const X_HANDLE = "@reddoorlife"; // Update with actual social media handle if different
